...
module.exports = {
  ...
  entry: {
    // js 入口
    'miniprogram-app': resolve('../src/mp/app.js'),
    index: resolve('../src/main.js')
  },
  output: {
    path: resolve('../dist/mp/miniprogram/common'), // 放到小程序代码目录中的 common 目录下
  ...
  plugins: [
    new CopyPlugin([{
      from: resolve('../cloudfunctions'), to: resolve('../dist/mp/cloudfunctions'),
      ignore: [
        "*/node_modules/**/*"
      ]
    }]),
